    ...
    <section id="education" className="py-20 bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800/50">
      <div className="container px-6 mx-auto">
        <div className="mb-16 text-center">
          <span className="inline-block px-3 py-1 mb-4 text-sm font-medium rounded-full bg-secondary/10 text-secondary">
        ...
        <div className="space-y-12">
          {educationData.map((edu, index) => (
            <div
              key={index}
              className="p-6 bg-white border border-gray-100 shadow-md dark:bg-gray-800 rounded-xl dark:border-gray-700"
            >
